...
if opt ==1; [numopen, denopen, denclsd]=pcomp(num,den,s1);
elseif opt ==2; [numopen, denopen, denclsd]=phlead(num,den,s1);
elseif opt ==3; [numopen, denopen, denclsd]=phlag(num,den,s1);
elseif opt ==4; [numopen, denopen, denclsd]=pdcomp(num,den,s1);
elseif opt ==5; [numopen, denopen, denclsd]=picomp(num,den,s1);
elseif opt ==6; [numopen, denopen, denclsd]=pidcomp(num,den,s1);
elseif opt ==0;   return
end
