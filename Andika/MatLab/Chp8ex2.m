...
title(['Three-phase short circuit  i_a,  ','\delta = ', num2str(deg),'\circ'])
figure(2), plot(t,ib), xlabel('t, sec'), ylabel('i_b, A'), grid
title(['Three-phase short circuit  i_b,  ','\delta = ', num2str(deg),'\circ'])
figure(3), plot(t,ic), xlabel('t, sec'), ylabel('i_c, A'), grid
title(['Three-phase short circuit  i_c,  ','\delta = ', num2str(deg),'\circ'])
figure(4), plot(t,iF), xlabel('t, sec'), ylabel('i_F, A'), grid
